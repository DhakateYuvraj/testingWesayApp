  ...
  continue(){
	...
	presentConfirm() {
		let alert = this.alertCtrl.create({
			...
			message: 'This is an alpha test version of the app. Please note that there may be bugs and some of the functionality may be unavailable. I understand and wish to proceed with being part of the Alpha Test.',
			buttons: [
				{
					text: 'Decline',
					role: 'cancel',
