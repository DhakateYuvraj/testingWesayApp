...
export class FeedbackPage {
  ...
  sendFeedback() {
    if (
      this.feedbackForm.value.likeConcept ||
      ...
      let feedbackFormObj = {
        q1: this.feedbackForm.value.likeConcept
          ? this.feedbackForm.value.likeConcept
          : null,
        q2: [
          this.feedbackForm.value.helpYouselfOptions
        ...
        q3: this.feedbackForm.value.isFriendly
          ? this.feedbackForm.value.isFriendly
          : null,
        q4: this.feedbackForm.value.whatYouLikeMost
          ? this.feedbackForm.value.whatYouLikeMost
          : null,
        q5: [
          this.feedbackForm.value.isBuggy
        ...
        q6: this.feedbackForm.value.performance
          ? this.feedbackForm.value.performance
          : null,
        q7: this.feedbackForm.value.recommendToFrd
          ? this.feedbackForm.value.recommendToFrd
          : null,
        q8: this.feedbackForm.value.NewFeaturesToSee
          ? this.feedbackForm.value.NewFeaturesToSee
          : null,
        q9: this.feedbackForm.value.otherSuggestions
          ? this.feedbackForm.value.otherSuggestions
          : null
      };
      this.traitService
        .saveFeedback(this.authToken, feedbackFormObj)
        .subscribe(data => {
