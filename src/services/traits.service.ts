...
export class TraitService {
  ...
  getAllTrais(token) {
    ...
    return this.http
      .post(rootApi + "/traitapi/getActiveTraits/", null, this.options)
      .map(res => res.json());
  }
  ...
  getListOfPopularTraits(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/traitapi/getListOfPopularTraits/", {}, this.options)
      .map(res => res.json());
  }
  ...
  addTraitToPage(traits, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/traitapi/addTrait/", traits, this.options)
      .map(res => res.json());
  }
  ...
  getLoginUserTraits(token, profile) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userTraits/getMyTraits/", profile, this.options)
      .map(res => res.json());
  }
  ...
  getMyFriendList(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/friendsZone/", null, this.options)
      .map(res => res.json());
  }
  ...
  searchUser(token, userObj) {
    ...
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/api/searchUser/", userObj, this.options)
      .map(res => res.json());
  }
  ...
  getSettings(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/mysettings/", null, this.options)
      .map(res => res.json());
  }
  ...
  updateSettings(token, settingObj) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/changemysettings/", settingObj, this.options)
      .map(res => res.json());
  }
  ...
  addContacts(list, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/uploadContact/", list, this.options)
      .map(res => res.json());
  }
  ...
  getTraitDetails(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userTraits/details", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  hideTrait(traitdata, token) {
    ...
    return this.http
      .post(
        rootApi + "/traitapi/hideUnhideTraitForUser/",
        traitdata,
        this.options
      )
      .map(res => res.json());
  ...
  hideTraitCount(traitdata, token) {
    ...
    return this.http
      .post(
        rootApi + "/traitapi/traits/hideUnhideCount/",
        traitdata,
        this.options
      )
      .map(res => res.json());
  ...
  deleteTrait(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/traitapi/deleteUserTrait/", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  customPoints(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/traits/ratings", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  commentList(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/traits/comment/list", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  commentLikeDislike(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/traits/comment/like", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  commentAdd(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/traits/comment", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  commentDelete(traitdata, token) {
    ...
    return this.http
      .post(
        rootApi + "/userTraits/traits/deleteComment",
        traitdata,
        this.options
      )
      .map(res => res.json());
  ...
  giveVote(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/traits/vote/submit", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  rejectUserTrait(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/traitapi/rejectUserTrait/", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  acceptUserTrait(traitdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/traitapi/acceptUserTrait/", traitdata, this.options)
      .map(res => res.json());
  }
  ...
  getUserProfile(userdata, token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/api/user/details/", userdata, this.options)
      .map(res => res.json());
  }
  ...
  getBadgesMasterList(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .get(rootApi + "/badge/getBadgeGallery/", this.options)
      .map(res => res.json());
  }
  ...
  getAvailableBadgesCnt(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .get(rootApi + "/badge/availableBadgeCount/", this.options)
      .map(res => res.json());
  }
  ...
  getAvailableBadges(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .get(rootApi + "/badge/availableBadges/", this.options)
      .map(res => res.json());
  }
  ...
  getReceivedBadges(token, userId) {
    this.createAuthenticationHeaders(token);
    return this.http
      .get(rootApi + "/badge/receivedBadges/?userid=" + userId, this.options)
      .map(res => res.json());
  }
  ...
  getGivenBadges(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .get(rootApi + "/badge/givenBadges/", this.options)
      .map(res => res.json());
  }
  ...
  getGivenBadgesCnt(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .get(rootApi + "/badge/givenBadgeCount/", this.options)
      .map(res => res.json());
  }
  ...
  giveBadgeToFriend(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/giveBadge/", badgeInfo, this.options)
      .map(res => res.json());
  }
  ...
  getBadgeDetails(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/badgeDetail/", badgeInfo, this.options)
      .map(res => res.json());
  ...
  getGivenBadgeDetails(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/givenBadgeDetails/", badgeInfo, this.options)
      .map(res => res.json());
  }
  ...
  deleteBadge(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/deleteBadge/", badgeInfo, this.options)
      .map(res => res.json());
  }
  ...
  hideUnhideBadge(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/hideBadge/", badgeInfo, this.options)
      .map(res => res.json());
  }
  ...
  acknowledgeBadge(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/acknowledgeBadge/", badgeInfo, this.options)
      .map(res => res.json());
  }
  ...
  acceptRejectBadge(token, badgeInfo) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/badge/acceptRejectBadge/", badgeInfo, this.options)
      .map(res => res.json());
  }
  ...
  getProfileData(token, payload) {
    ...
    //{"userid":0}
    return this.http
      .post(rootApi + "/userzone/myprofileview", payload, this.options)
      .map(res => res.json());
  }
  ...
  updateMyProfile(token, payload) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/userzone/myprofile", payload, this.options)
      .map(res => res.json());
  }
  ...
  loadGenericSetting(token) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/api/genericSetting/", null, this.options)
      .map(res => res.json());
  }
  ...
  fcmTokenSend(token, fcmDeviceInfo) {
    ...
    return this.http
      .post(
        rootApi + "/api/persistdeviceregistrationid/",
        fcmDeviceInfo,
        this.options
      )
      .map(res => res.json());
  ...
  saveFeedback(token, payload) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(rootApi + "/feedback/saveFeedback/", payload, this.options)
      .map(res => res.json());
  }
  ...
  getTstmMasterList(token) {
    ...
    return this.http
      .post(
        rootApi + "/testimonialapi/api/getTestimonials/ ",
        null,
        this.options
      )
      .map(res => res.json());
  ...
  changeMyTestimonialSettings(token, payload) {
    this.createAuthenticationHeaders(token);
    return this.http
      .post(
        rootApi + "/testimonialapi/api/changeMyTestimonialSettings/ ",
        payload,
        this.options
      )
      .map(res => res.json());
